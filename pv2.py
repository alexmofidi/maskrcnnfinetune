...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 3  # Background + pv_psv_saddle
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("pv", 1, "pv")
        self.add_class("pv", 2, "psv")
        self.add_class("pv", 3, "flange")
        ...
        annotations1 = json.load(open(os.path.join(dataset_dir, "pv.json")))
        # print(annotations1)
        ...
        for a in annotations:
            ...
            self.add_image(
                "pv",  ## for a single class just add the name here
